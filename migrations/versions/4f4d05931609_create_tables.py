...
<<<<<<<< HEAD:migrations/versions/ff1205b64e19_initial_migration.py
...
>>>>>>>> bf24371e492ad4b8b7df40ee9cc090ad4dd6fe12:migrations/versions/4f4d05931609_create_tables.py
...
def upgrade():
    ...
    sa.Column('business_desc', sa.String(length=50), nullable=False),
    sa.Column('specific_location', sa.String(length=150), nullable=False),
    sa.Column('date_added', sa.DateTime(), nullable=True),
    sa.Column('weekday', sa.String(length=250), nullable=False),
    sa.Column('from_hour', sa.String(length=250), nullable=False),
    sa.Column('to_hour', sa.String(length=250), nullable=False),
    sa.ForeignKeyConstraint(['business_owner'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('business_name'),
    sa.UniqueConstraint('business_owner'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('engineerUser', sa.Integer(), nullable=False),
    sa.Column('profesion', sa.String(length=250), nullable=False),
    sa.Column('specification', sa.String(length=250), nullable=False),
    sa.Column('location', sa.String(length=150), nullable=False),
    sa.Column('phoneNumber', sa.String(length=150), nullable=False),
    sa.Column('website', sa.String(length=200), nullable=True),
    sa.Column('linkdin', sa.String(length=200), nullable=True),
    sa.Column('twitter', sa.String(length=200), nullable=True),
    sa.Column('instagram', sa.String(length=200), nullable=True),
    sa.Column('date_added', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['engineerUser'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
